...
void ingresarPlato(char**& bloqueCadena,int* bloqueEntero,const Pedido pedido);

void ingresarPrecios(double*& reales,char** cadenas,int* entero,
                    const ConjuntoDePlatos conjuntoDePlatos,int cantTipos);
