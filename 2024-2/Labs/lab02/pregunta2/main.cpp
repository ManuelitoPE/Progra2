...
void test07() {
    ...
    cargar_conjunto_de_pedidos(conjuntoDePedidos, "docs/pedidos.txt");
...
void test03() {
    ifstream archivo_de_pedidos("docs/pedidos.txt", ios::in);
...
void test02() {
    ...
    cargar_conjunto_de_repartidores(conjuntoDeRepartidores, "docs/repartidores.csv");
